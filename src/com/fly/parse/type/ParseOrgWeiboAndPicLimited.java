 ...
 *
 */
public class ParseOrgWeiboAndPicLimited implements WeiboParseProcessor{
	...
	public void parse(Element e){
		...
		Element trans_A=two_div.get(1).getElementsByClass("cmt").get(0);
		...
		Element comment_A=two_div.get(1).getElementsByTag("a").get(3);
		...
		//Store into DataBase
			try {
				StorageTool.insertInitWeibo(article);
