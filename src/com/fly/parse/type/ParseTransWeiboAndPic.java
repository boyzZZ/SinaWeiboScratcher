...
public class ParseTransWeiboAndPic {
	/**
	 * static function for Parsing TransWeibo Containing Pic
	...
	public  void parse(Element e){
		    ...
		    if(all_a.size()==5){
		    	...
		    	trans_amt=Integer.parseInt(thirdDiv.getElementsByClass("cmt").get(1).text().substring(3,thirdDiv.getElementsByClass("cmt").get(0).text().length()-1));
